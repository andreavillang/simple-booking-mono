...
public class BackendApplication {
	...
	CommandLineRunner commandLineRunner(AppointmentRepository repository) {
		return args -> {
			...
			repository.save(new Appointment(null, "Lucas Santos", "Mandatory annual physical examination from workplace", LocalDateTime.of(2023,11,21,11,0,0,0), "1234"));
			repository.save(new Appointment(null, "Veronica Tiu", "Mandatory annual physical examination from workplace", LocalDateTime.of(2023,11,21,13,0,0,0), "1234"));
			...
			repository.save(new Appointment(null, "Mico Aquino", "Mandatory annual physical examination from workplace", LocalDateTime.of(2023,11,23,9,0,0,0), "1234"));
			repository.save(new Appointment(null, "Jay Kay", "Mandatory annual physical examination from workplace", LocalDateTime.of(2023,11,23,8,0,0,0), "1234"));
